...
<!-- Vendors JS -->
<script src="<?= base_url('templeate/assets/vendor/libs/apex-charts/apexcharts.js') ?>"></script>

<!-- Main JS -->
<script src="<?= base_url('templeate/assets/js/main.js') ?>"></script>

<!-- Page JS -->
<script src="<?= base_url('templeate/assets/js/dashboards-analytics.js') ?>"></script>
