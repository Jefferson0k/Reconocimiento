...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default"
    data-assets-path="<?= base_url('templeate/assets/') ?>" data-template="vertical-menu-template-free">
...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="<?= base_url('templeate/assets/vendor/css/core.css') ?>"
        class="template-customizer-core-css" />
    <link rel="stylesheet" href="<?= base_url('templeate/assets/vendor/css/theme-default.css') ?>"
        class="template-customizer-theme-css" />
    <link rel="stylesheet" href="<?= base_url('templeate/assets/css/demo.css') ?>" />

    <!-- Vendors CSS -->
    <link rel="stylesheet"
        href="<?= base_url('templeate/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') ?>" />

    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?= base_url('templeate/assets/vendor/css/pages/page-auth.css') ?>" />
    <!-- Helpers -->
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3 needs-validation" method="post" action="<?= base_url('Login/doLogin'); ?>" novalidate >
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="user" name="user"
                                        placeholder="Enter your email or username" autofocus value="<?= old('user') ?>" required />
                            </div>
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="pass" class="form-control" name="pass"
                                        placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                        aria-describedby="pass" value="<?= old('pass') ?>" required />
