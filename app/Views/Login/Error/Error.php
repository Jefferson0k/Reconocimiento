...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?= base_url('templeate/assets/vendor/css/pages/page-misc.css') ?>" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <a href="<?= base_url('/Login/cerrarsesion') ?>" class="btn btn-primary">Back to home</a>
        <div class="mt-3">
          <img
            src="<?= base_url('templeate/assets/img/illustrations/page-misc-error-light.png') ?>"
